...
REPO_SUFFIX=("extract" "extract-carbon" "pipeline" "dashboard", "email-service", "webhooks")
IMAGE_NAMES=("extract_to_s3" "extract_carbon" "transform_load" "dashboard", "email-service", "webhooks")
DOCKERFILES=("Dockerfile.extract_many" "Dockerfile.extract_carbon" "Dockerfile.transform_load" "Dockerfile.dashboard", "Dockerfile.email", "Dockerfile.webhooks")
